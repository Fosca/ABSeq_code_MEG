...
def prepare_epochs_for_regression(subject, cleaned, epochs_fname, regressors_names, filter_name, remap_channels, apply_baseline, suffix):
    ...
    if epochs_fname == '':
        epochs = filter_good_epochs_for_regression_analysis(subject, clean=cleaned,
    ...
    if apply_baseline and epochs_final.baseline is None:
    ...
    filters = filter_string_for_metadata()
...
# ----------------------------------------------------------------------------------------------------------------------
def compute_regression(subject, regressors_names, epochs_fname, filter_name, cleaned=True, remap_channels='grad_to_mag',
