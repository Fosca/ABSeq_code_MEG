...
###################### COLORMAP ############################################
seqcolors_jet10 = [[0, 0, 2 / 3], [0, 0, 1], [0, 1 / 3, 1],
                   [0, 2 / 3, 1], [0, 1, 1], [1 / 3, 1, 2 / 3], [2 / 3, 1, 1 / 3],
                   [1, 1, 0], [1, 2 / 3, 0], [1, 1 / 3, 0]]  # colors for 10 sequences as in fMRI
seqcolors_turbomap10 = [[0.1900, 0.0718, 0.2322], [0.2737, 0.3835, 0.8449], [0.2093, 0.6654, 0.9760],
                        [0.1034, 0.8960, 0.7150], [0.4483, 0.9959, 0.3694], [0.7824, 0.9376, 0.2033],
                        [0.9800, 0.7300, 0.2216], [0.9643, 0.4186, 0.0964], [0.7941, 0.1660, 0.0143],
                        [0.4796, 0.0158, 0.0106]]
seqcolors_turbo7 = [[0.19, 0.0718, 0.2322], [0.2733, 0.5255, 0.9818], [0.1034, 0.896, 0.715], [0.6384, 0.991, 0.2365], [0.98, 0.73, 0.2216],
                    [0.8959, 0.274, 0.0412], [0.4796, 0.0158, 0.0106]]
seqcolors_plasma7 = [[0.2943, 0.0101, 0.6298], [0.4905, 0.0106, 0.6584], [0.6622, 0.1358, 0.5877], [0.7964, 0.278, 0.4713],
                     [0.9007, 0.4233, 0.3609], [0.973, 0.5844, 0.2524], [0.9931, 0.7709, 0.1551]]
seqcolors = seqcolors_plasma7
